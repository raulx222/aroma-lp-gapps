...
case "$1" in
	...
	[[ -d /system/app/Eleven || -d /system/app/Apollo || -d /system/app/Music2 ]] && echo "music=1" >> /tmp/protection.prop || echo "music=0" >> /tmp/protection.prop
	;;
	aroma-config)
	...
	[[ -d /system/app/Eleven || -d /system/app/Apollo ]] && echo "music=1" >> /tmp/protection.prop || echo "music=0" >> /tmp/protection.prop
	;;
esac
